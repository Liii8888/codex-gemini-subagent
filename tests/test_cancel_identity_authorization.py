    ...
    def setUp(self) -> None:
        ...
        self.environment = mock.patch.dict(
            os.environ,
            {
                ...
                "GEMINI_SUBAGENT_GEMINI_BIN": str(Path(__file__).resolve().parent / "mock_google_cli.py"),
                "GEMINI_SUBAGENT_AGY_BIN": str(Path(__file__).resolve().parent / "mock_google_cli.py"),
