...
| Check | Result |
| --- | --- |
| Full mock-provider test discovery, Python 3.14.6 on macOS | 199 tests passed |
...
| Installed bundle compared with source | All 45 plugin files matched byte for byte |
...
shared/exclusive locks, concurrency eligibility, and public runtime defaults.
